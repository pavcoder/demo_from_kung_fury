...
#c.create_line(600,400,600,600,width=6,fill="deep pink")
...
#c.create_line(100,400,200,200,width=6,fill="deep pink")
#c.create_line(300,400,200,200,width=6,fill="deep pink")
obj1=c.create_line(0,obj1_x+150,1100,obj1_x+150,width=6,fill="deep pink")
#obj2=c.create_line(0,obj1_x+10,1200,obj1_x+25,width=6,fill="deep pink")
obj3=c.create_line(0,obj1_x+100,1100,obj1_x+100,width=6,fill="deep pink")
obj4=c.create_line(0,obj1_x+50,1100,obj1_x+50,width=6,fill="deep pink")
obj5=c.create_line(0,obj1_x,1100,obj1_x,width=6,fill="deep pink")
...
def redraw_obj4():
	...
	c.update()
def redraw_obj5():
	c.after(50,redraw_obj5)
	c.move(obj5,0,5)
	if c.coords(obj5)[1]>=600:
		c.coords(obj5,0,400,1200,400)
	c.update()
def redraw_text():
